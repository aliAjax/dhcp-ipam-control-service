...
func main() {
	...
	go func() {
		if err := dhcp4adapter.Listen(dhcpListenerContext(ctx), cfg.DHCPv4Addr, dhcp4srv, logger); err != nil && !errors.Is(err, context.Canceled) {
...
func dhcpListenerContext(context.Context) context.Context {
